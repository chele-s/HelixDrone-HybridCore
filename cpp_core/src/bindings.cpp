...
PYBIND11_MODULE(drone_core, m) {
  m.doc() = "State-of-the-Art Quadrotor Physics Engine with SIMD, Blade "
            "Flapping, Variable Mass, and Sub-Stepping";
  ...
  py::class_<MotorCommand>(m, "MotorCommand")
      ...
      .def("__repr__",
           [](const MotorCommand &cmd) {
             return "MotorCommand(" + std::to_string(cmd.rpm[0]) + ", " +
                    std::to_string(cmd.rpm[1]) + ", " +
                    std::to_string(cmd.rpm[2]) + ", " +
                    std::to_string(cmd.rpm[3]) + ")";
           })
      .def("__getitem__", [](const MotorCommand &cmd, int i) { return cmd[i]; })
      .def("__setitem__",
           [](MotorCommand &cmd, int i, double v) { cmd[i] = v; })
  ...
  py::class_<BladeFlappingConfig>(m, "BladeFlappingConfig")
      ...
      .def_readwrite("pitch_flap_coupling",
                     &BladeFlappingConfig::pitchFlapCoupling)
      .def_readwrite("roll_flap_coupling",
                     &BladeFlappingConfig::rollFlapCoupling)
      .def_readwrite("advance_ratio_threshold",
                     &BladeFlappingConfig::advanceRatioThreshold)
  ...
  py::class_<FuelConfig>(m, "FuelConfig")
      ...
      .def_readwrite("specific_fuel_consumption",
                     &FuelConfig::specificFuelConsumption)
  ...
  py::class_<AeroConfig>(m, "AeroConfig")
      ...
      .def_readwrite("advance_ratio_drag_scale",
                     &AeroConfig::advanceRatioDragScale);
  ...
  py::class_<QuadrotorConfig>(m, "QuadrotorConfig")
      ...
      .def_readwrite("enable_ground_effect",
                     &QuadrotorConfig::enableGroundEffect)
      .def_readwrite("enable_wind_disturbance",
                     &QuadrotorConfig::enableWindDisturbance)
      .def_readwrite("enable_motor_dynamics",
                     &QuadrotorConfig::enableMotorDynamics)
      .def_readwrite("enable_battery_dynamics",
                     &QuadrotorConfig::enableBatteryDynamics)
      .def_readwrite("enable_imu", &QuadrotorConfig::enableIMU)
      .def_readwrite("enable_nonlinear_motor",
                     &QuadrotorConfig::enableNonlinearMotor)
      .def_readwrite("enable_blade_flapping",
                     &QuadrotorConfig::enableBladeFlapping)
      .def_readwrite("enable_variable_mass",
                     &QuadrotorConfig::enableVariableMass)
      .def_readwrite("enable_advanced_aero",
                     &QuadrotorConfig::enableAdvancedAero)
  ...
  py::class_<Quadrotor>(m, "Quadrotor")
      ...
      .def("get_config", &Quadrotor::getConfig,
  ...
  py::class_<PhysicsEngine>(m, "PhysicsEngine")
      ...
      .def_static("compute_inertia_from_mass",
                  &PhysicsEngine::computeInertiaFromMass)
  ...
  py::class_<NonlinearMotorModel>(m, "NonlinearMotorModel")
      .def_static("compute_nonlinear_response",
                  &NonlinearMotorModel::computeNonlinearResponse)
      .def_static("compute_esc_delay", &NonlinearMotorModel::computeESCDelay)
      .def_static("compute_soft_current_limit",
                  &NonlinearMotorModel::computeSoftCurrentLimit)
      .def_static("compute_thermal_derating",
                  &NonlinearMotorModel::computeThermalDerating);

  py::class_<BladeFlappingModel>(m, "BladeFlappingModel")
      .def_static("compute_advance_ratio",
                  &BladeFlappingModel::computeAdvanceRatio);

  py::class_<VariableMassModel>(m, "VariableMassModel")
      .def_static("compute_inertia_with_fuel",
                  &VariableMassModel::computeInertiaWithFuel);
  ...
  py::class_<helix::SumTree>(m, "SumTree")
      ...
      .def("get",
           [](const helix::SumTree &self, double value) {
  ...
  py::class_<helix::PrioritizedReplayBuffer>(m, "PrioritizedReplayBuffer")
      .def(py::init<size_t, size_t, size_t, double, double, size_t, double>(),
           py::arg("capacity"), py::arg("state_dim"), py::arg("action_dim"),
           py::arg("alpha") = 0.6, py::arg("beta_start") = 0.4,
           py::arg("beta_frames") = 100000, py::arg("epsilon") = 1e-6)
      .def("beta", &helix::PrioritizedReplayBuffer::beta)
      .def("push",
           [](helix::PrioritizedReplayBuffer &self,
              ...
              py::array_t<float, py::array::c_style | py::array::forcecast>
                  next_state,
              float done) {
             self.push(state.data(), action.data(), reward, next_state.data(),
                       done);
           })
      .def("push_batch",
           [](helix::PrioritizedReplayBuffer &self,
             ...
             self.pushBatch(states.data(), actions.data(), rewards.data(),
                            next_states.data(), dones.data(),
                            static_cast<size_t>(states.shape(0)));
           })
      .def("sample",
           [](helix::PrioritizedReplayBuffer &self, size_t batchSize) {
             auto result = self.sample(batchSize);

             py::array_t<float> states(
                 {static_cast<py::ssize_t>(batchSize),
                  static_cast<py::ssize_t>(result.stateDim)});
             py::array_t<float> actions(
                 {static_cast<py::ssize_t>(batchSize),
                  static_cast<py::ssize_t>(result.actionDim)});
             py::array_t<float> rewards({static_cast<py::ssize_t>(batchSize),
                                         static_cast<py::ssize_t>(1)});
             py::array_t<float> next_states(
                 {static_cast<py::ssize_t>(batchSize),
                  static_cast<py::ssize_t>(result.stateDim)});
             py::array_t<float> dones({static_cast<py::ssize_t>(batchSize),
                                       static_cast<py::ssize_t>(1)});
             py::array_t<float> weights({static_cast<py::ssize_t>(batchSize),
                                         static_cast<py::ssize_t>(1)});
             py::array_t<int32_t> tree_indices(
                 {static_cast<py::ssize_t>(batchSize)});

             std::memcpy(states.mutable_data(), result.states.data(),
                         batchSize * result.stateDim * sizeof(float));
             std::memcpy(actions.mutable_data(), result.actions.data(),
                         batchSize * result.actionDim * sizeof(float));
             std::memcpy(next_states.mutable_data(), result.nextStates.data(),
                         batchSize * result.stateDim * sizeof(float));
             std::memcpy(tree_indices.mutable_data(), result.treeIndices.data(),
                         batchSize * sizeof(int32_t));
      ...
      .def("update_priorities",
           [](helix::PrioritizedReplayBuffer &self,
              ...
              py::array_t<double, py::array::c_style | py::array::forcecast>
                  td_errors) {
             self.updatePriorities(tree_indices.data(), td_errors.data(),
                                   static_cast<size_t>(tree_indices.size()));
           })
  ...
  py::class_<helix::UniformReplayBuffer>(m, "UniformReplayBuffer")
      .def(py::init<size_t, size_t, size_t>(), py::arg("capacity"),
           py::arg("state_dim"), py::arg("action_dim"))
      .def("push",
           [](helix::UniformReplayBuffer &self,
              py::array_t<float, py::array::c_style | py::array::forcecast>
                  state,
              py::array_t<float, py::array::c_style | py::array::forcecast>
                  action,
      ...
      .def("sample",
           [](helix::UniformReplayBuffer &self, size_t batchSize,
              size_t stateDim, size_t actionDim) {
             auto result = self.sample(batchSize);

             py::array_t<float> states({static_cast<py::ssize_t>(batchSize),
                                        static_cast<py::ssize_t>(stateDim)});
             py::array_t<float> actions({static_cast<py::ssize_t>(batchSize),
                                         static_cast<py::ssize_t>(actionDim)});
             py::array_t<float> rewards({static_cast<py::ssize_t>(batchSize),
                                         static_cast<py::ssize_t>(1)});
             py::array_t<float> next_states(
                 {static_cast<py::ssize_t>(batchSize),
             ...
             std::memcpy(states.mutable_data(), result.states.data(),
                         batchSize * stateDim * sizeof(float));
             std::memcpy(actions.mutable_data(), result.actions.data(),
                         batchSize * actionDim * sizeof(float));
             std::memcpy(next_states.mutable_data(), result.nextStates.data(),
                         batchSize * stateDim * sizeof(float));
             ...
             return py::make_tuple(states, actions, rewards, next_states,
                                   dones);
           })
  ...
  py::class_<SOTAActuatorConfig>(m, "SOTAActuatorConfig")
      ...
      .def_readwrite("voltage_sag_factor",
                     &SOTAActuatorConfig::voltageSagFactor)
      ...
      .def_readwrite("active_braking_gain",
                     &SOTAActuatorConfig::activeBrakingGain)
      .def_readwrite("thermal_time_constant",
                     &SOTAActuatorConfig::thermalTimeConstant)
  ...
  py::class_<SOTAActuatorState>(m, "SOTAActuatorState")
      .def(py::init<>())
      .def_property_readonly("current_rpm",
                             [](const SOTAActuatorState &s) {
                               return std::vector<double>(s.currentRpm,
                                                          s.currentRpm + 4);
                             })
      .def_property_readonly("filtered_rpm",
                             [](const SOTAActuatorState &s) {
                               return std::vector<double>(s.filteredRpm,
                                                          s.filteredRpm + 4);
                             })
      .def_property_readonly("motor_temperature",
                             [](const SOTAActuatorState &s) {
                               return std::vector<double>(
                                   s.motorTemperature, s.motorTemperature + 4);
                             })
      .def_property_readonly("total_current",
                             [](const SOTAActuatorState &s) {
                               return std::vector<double>(s.totalCurrent,
                                                          s.totalCurrent + 4);
                             })
      .def_property_readonly("thermal_efficiency",
                             [](const SOTAActuatorState &s) {
                               return std::vector<double>(s.thermalEfficiency,
                                                          s.thermalEfficiency +
                                                              4);
                             })
      .def_property_readonly("rpm_derivative",
                             [](const SOTAActuatorState &s) {
                               return std::vector<double>(s.rpmDerivative,
                                                          s.rpmDerivative + 4);
                             })
      .def_property_readonly("previous_target",
                             [](const SOTAActuatorState &s) {
                               return std::vector<double>(s.previousTarget,
                                                          s.previousTarget + 4);
                             })
  ...
  py::class_<SOTAActuatorModel>(m, "SOTAActuatorModel")
      ...
      .def("step",
           [](SOTAActuatorModel &self,
              py::array_t<double, py::array::c_style | py::array::forcecast>
                  commanded_rpm,
              double dt, double voltage) {
             py::array_t<double> output(4);
             self.step(commanded_rpm.data(), dt, voltage,
                       output.mutable_data());
             return output;
           })
      .def("step_normalized",
  ...
  py::class_<SOTAButterworthFilter>(m, "SOTAButterworthFilter")
      ...
      .def(py::init<int, double, double>(), py::arg("order"),
           py::arg("cutoff_hz"), py::arg("sample_rate"))
  ...
  py::class_<SensorNoise>(m, "SensorNoise")
      ...
      .def_readwrite("cable_angle_update_rate",
                     &SensorNoise::cable_angle_update_rate)
      .def_readwrite("cable_sensor_enabled",
                     &SensorNoise::cable_sensor_enabled);
  ...
  py::class_<RobustnessConfig>(m, "RobustnessConfig")
      .def(py::init<>())
      .def_readwrite("enable_chi_square_gating",
                     &RobustnessConfig::enable_chi_square_gating)
      .def_readwrite("enable_fault_detection",
                     &RobustnessConfig::enable_fault_detection)
      .def_readwrite("enable_adaptive_noise",
                     &RobustnessConfig::enable_adaptive_noise)
      .def_readwrite("enable_state_dependent_noise",
                     &RobustnessConfig::enable_state_dependent_noise)
      .def_readwrite("chi_square_threshold_1dof",
                     &RobustnessConfig::chi_square_threshold_1dof)
      .def_readwrite("chi_square_threshold_3dof",
                     &RobustnessConfig::chi_square_threshold_3dof)
      .def_readwrite("max_consecutive_rejections",
                     &RobustnessConfig::max_consecutive_rejections)
      .def_readwrite("adaptive_alpha", &RobustnessConfig::adaptive_alpha)
      .def_readwrite("gyro_noise_scale_coeff",
                     &RobustnessConfig::gyro_noise_scale_coeff)
      .def_readwrite("accel_noise_scale_coeff",
                     &RobustnessConfig::accel_noise_scale_coeff)
      .def_readwrite("enable_external_force_estimation",
                     &RobustnessConfig::enable_external_force_estimation)
      .def_readwrite("external_force_process_noise",
                     &RobustnessConfig::external_force_process_noise);
  ...
  py::class_<ExtendedKalmanFilter>(m, "ExtendedKalmanFilter")
      ...
      .def("reset",
           py::overload_cast<const Vec3 &, const Vec3 &, const Quaternion &>(
      ...
      .def("get_position_uncertainty",
           &ExtendedKalmanFilter::getPositionUncertainty)
      .def("get_orientation_uncertainty",
           &ExtendedKalmanFilter::getOrientationUncertainty)
      ...
      .def("get_consistency_metrics",
           &ExtendedKalmanFilter::getConsistencyMetrics)
  ...
  py::class_<FailureConfig>(m, "FailureConfig")
      ...
      .def_readwrite("oscillation_amplitude",
                     &FailureConfig::oscillation_amplitude)
      ...
      .def_readwrite("intermittent_on_time",
                     &FailureConfig::intermittent_on_time)
      .def_readwrite("intermittent_off_time",
                     &FailureConfig::intermittent_off_time)
  ...
  py::class_<ActuatorFailureInjector>(m, "ActuatorFailureInjector")
      .def(py::init<>())
      .def("inject_failure", py::overload_cast<const FailureConfig &>(
                                 &ActuatorFailureInjector::injectFailure))
      .def("inject_failure", py::overload_cast<int, FailureType, double>(
                                 &ActuatorFailureInjector::injectFailure))
      ...
      .def(
          "apply_failures",
          [](ActuatorFailureInjector &self,
             py::array_t<double, py::array::c_style | py::array::forcecast> rpm,
             double dt) { self.applyFailures(rpm.mutable_data(), dt); })
      .def("reset", &ActuatorFailureInjector::reset)
      .def("has_active_failure",
           py::overload_cast<>(&ActuatorFailureInjector::hasActiveFailure,
                               py::const_))
      .def("has_active_failure",
           py::overload_cast<int>(&ActuatorFailureInjector::hasActiveFailure,
                                  py::const_))
      ...
      .def("set_random_failure_probability",
           &ActuatorFailureInjector::setRandomFailureProbability)
      .def("enable_random_failures",
           &ActuatorFailureInjector::enableRandomFailures);

  py::enum_<FailureScenarioGenerator::Scenario>(m, "FailureScenario")
      .value("SINGLE_MOTOR_LOSS",
             FailureScenarioGenerator::Scenario::SINGLE_MOTOR_LOSS)
      .value("DUAL_MOTOR_LOSS",
             FailureScenarioGenerator::Scenario::DUAL_MOTOR_LOSS)
      .value("OPPOSITE_MOTOR_LOSS",
             FailureScenarioGenerator::Scenario::OPPOSITE_MOTOR_LOSS)
      .value("ADJACENT_MOTOR_LOSS",
             FailureScenarioGenerator::Scenario::ADJACENT_MOTOR_LOSS)
      .value("PROGRESSIVE_DEGRADATION",
             FailureScenarioGenerator::Scenario::PROGRESSIVE_DEGRADATION)
      .value("RANDOM_INTERMITTENT",
             FailureScenarioGenerator::Scenario::RANDOM_INTERMITTENT)
      .value("THERMAL_RUNWAY",
             FailureScenarioGenerator::Scenario::THERMAL_RUNWAY)
      .value("CASCADING_FAILURE",
             FailureScenarioGenerator::Scenario::CASCADING_FAILURE);

  py::class_<FailureScenarioGenerator>(m, "FailureScenarioGenerator")
      .def_static(
          "generate_scenario", &FailureScenarioGenerator::generateScenario,
          py::arg("injector"), py::arg("scenario"), py::arg("severity") = 1.0)
      .def_static("single_motor_loss",
                  &FailureScenarioGenerator::singleMotorLoss)
      .def_static("dual_motor_loss", &FailureScenarioGenerator::dualMotorLoss)
      .def_static("opposite_motor_loss",
                  &FailureScenarioGenerator::oppositeMotorLoss)
      .def_static("adjacent_motor_loss",
                  &FailureScenarioGenerator::adjacentMotorLoss)
      .def_static("progressive_degradation",
                  &FailureScenarioGenerator::progressiveDegradation)
      .def_static("random_intermittent",
                  &FailureScenarioGenerator::randomIntermittent)
      .def_static("thermal_runaway", &FailureScenarioGenerator::thermalRunaway)
      .def_static("cascading_failure",
                  &FailureScenarioGenerator::cascadingFailure);
  ...
  py::class_<Sphere>(m, "Sphere")
      ...
      .def("intersects",
           py::overload_cast<const Sphere &>(&Sphere::intersects, py::const_))
  ...
  py::class_<CollisionWorld>(m, "CollisionWorld")
      ...
      .def("add_ground_plane", &CollisionWorld::addGroundPlane,
           py::arg("height") = 0.0)
      ...
      .def("raycast", &CollisionWorld::raycast, py::arg("origin"),
           py::arg("direction"), py::arg("max_distance") = 1000.0)
      .def("line_of_sight", &CollisionWorld::lineOfSight)
      .def("get_colliders_in_radius", &CollisionWorld::getCollidersInRadius)
      .def("generate_random_obstacles",
           &CollisionWorld::generateRandomObstacles)
      .def("generate_urban_environment",
           &CollisionWorld::generateUrbanEnvironment)
      .def("generate_forest_environment",
           &CollisionWorld::generateForestEnvironment)
  ...
  py::class_<UnifiedXPBDSystem>(m, "XPBDCable")
      ...
      .def("step", &UnifiedXPBDSystem::step, py::arg("anchor_pos"),
           py::arg("anchor_vel"), py::arg("dt"), py::arg("wind") = Vec3(),
      ...
      .def("get_payload_particle_index",
           &UnifiedXPBDSystem::getPayloadParticleIndex)
      ...
      .def("get_potential_energy", &UnifiedXPBDSystem::getPotentialEnergy,
           py::arg("ground_height") = 0.0)
      .def("get_total_energy", &UnifiedXPBDSystem::getTotalEnergy,
           py::arg("ground_height") = 0.0)
  ...
  py::class_<PayloadDynamics>(m, "PayloadDynamics")
      ...
      .def("step", &PayloadDynamics::step, py::arg("drone_position"),
           py::arg("drone_orientation"), py::arg("drone_velocity"),
           py::arg("drone_angular_velocity"), py::arg("dt"),
           py::arg("air_density") = 1.225)
      .def("get_coupling_forces", &PayloadDynamics::getCouplingForces)
      .def("attach", &PayloadDynamics::attach,
           py::arg("initial_offset") = Vec3(0, 0, -1.0))
      ...
      .def("reset",
           py::overload_cast<const PayloadState &>(&PayloadDynamics::reset))
      ...
      .def("get_cable_angle_from_vertical",
           &PayloadDynamics::getCableAngleFromVertical)
      .def("get_natural_frequency", &PayloadDynamics::getNaturalFrequency);

  py::class_<SwingingPayloadController::LQRGains>(m, "LQRGains")
      .def(py::init<>())
      .def_readwrite("max_compensation",
                     &SwingingPayloadController::LQRGains::max_compensation)
      .def_readwrite("damping_ratio",
                     &SwingingPayloadController::LQRGains::damping_ratio);
  ...
  py::class_<SwingingPayloadController>(m, "SwingingPayloadController")
      ...
      .def("compute_compensation",
           &SwingingPayloadController::computeCompensation)
      .def("compute_input_shaping",
           &SwingingPayloadController::computeInputShaping)
      .def("compute_energy_based_control",
           &SwingingPayloadController::computeEnergyBasedControl)
      .def("compute_compensation_from_angles",
           &SwingingPayloadController::computeCompensationFromAngles)
      .def_static("estimate_payload_from_cable_angles",
                  &SwingingPayloadController::estimatePayloadFromCableAngles)
  ...
  py::class_<helix::SequenceReplayBuffer>(m, "SequenceReplayBuffer")
      .def(py::init<size_t, size_t, size_t, size_t, size_t>(),
           py::arg("capacity"), py::arg("obs_dim"), py::arg("action_dim"),
           py::arg("sequence_length"), py::arg("burn_in_length") = 0)
      .def("push",
           [](helix::SequenceReplayBuffer &self,
              ...
              py::array_t<float, py::array::c_style | py::array::forcecast>
                  next_obs,
              float done) {
             self.push(obs.data(), action.data(), reward, next_obs.data(),
                       done);
           })
      .def("push_batch",
           [](helix::SequenceReplayBuffer &self,
             ...
             self.pushBatch(obs.data(), actions.data(), rewards.data(),
                            next_obs.data(), dones.data(),
                            static_cast<size_t>(obs.shape(0)));
           })
      .def("sample",
           [](helix::SequenceReplayBuffer &self, size_t batchSize) {
             auto result = self.sample(batchSize);
             ...
             std::memcpy(obs_seq.mutable_data(), result.obs_seq.data(),
                         B * L * O * sizeof(float));
             std::memcpy(next_obs_seq.mutable_data(),
                         result.next_obs_seq.data(), B * L * O * sizeof(float));
             std::memcpy(action_seq.mutable_data(), result.action_seq.data(),
                         B * L * A * sizeof(float));
             std::memcpy(masks.mutable_data(), result.masks.data(),
                         B * L * sizeof(float));
             std::memcpy(start_indices.mutable_data(),
                         result.start_indices.data(), B * sizeof(size_t));
             ...
             for (size_t b = 0; b < result.batch_size; ++b) {
               std::memcpy(aPtr + b * A, seqPtr + (b * L + L - 1) * A,
                           A * sizeof(float));
             }
             ...
             if (BI > 0) {
               ...
               std::memcpy(burn_in_obs.mutable_data(),
                           result.burn_in_obs.data(),
                           B * BI * O * sizeof(float));
               std::memcpy(burn_in_next_obs.mutable_data(),
                           result.burn_in_next_obs.data(),
                           B * BI * O * sizeof(float));
               std::memcpy(burn_in_actions.mutable_data(),
                           result.burn_in_actions.data(),
                           B * BI * A * sizeof(float));
               std::memcpy(burn_in_masks.mutable_data(),
                           result.burn_in_masks.data(), B * BI * sizeof(float));
      ...
      .def("end_episode", &helix::SequenceReplayBuffer::endEpisode)
  ...
  py::class_<helix::SequencePrioritizedReplayBuffer>(
      m, "SequencePrioritizedReplayBuffer")
      ...
      .def("push",
           [](helix::SequencePrioritizedReplayBuffer &self,
              py::array_t<float, py::array::c_style | py::array::forcecast> obs,
              py::array_t<float, py::array::c_style | py::array::forcecast>
                  action,
              float reward,
      ...
      .def("sample",
           [](helix::SequencePrioritizedReplayBuffer &self, size_t batchSize) {
             auto result = self.sample(batchSize);
             py::ssize_t B = static_cast<py::ssize_t>(result.batch_size);
             py::ssize_t L = static_cast<py::ssize_t>(result.seq_len);
             py::ssize_t BI = static_cast<py::ssize_t>(result.burn_in_len);
      ...
      .def("update_priorities",
           [](helix::SequencePrioritizedReplayBuffer &self,
              ...
              py::array_t<double, py::array::c_style | py::array::forcecast>
                  td_errors) {
             self.updatePriorities(indices.data(), td_errors.data(),
                                   static_cast<size_t>(indices.size()));
           })
      .def("end_episode", &helix::SequencePrioritizedReplayBuffer::endEpisode)
      .def("size", &helix::SequencePrioritizedReplayBuffer::size)
      .def("burn_in_length",
           &helix::SequencePrioritizedReplayBuffer::burnInLength)
